...
const ConsultationPage = () => {
    ...
    return (
        <div ref={containerRef} className="h-screen w-full bg-[#FAF9F6] flex flex-col overflow-hidden relative selection:bg-[#2D5A43] selection:text-white">
            ...
            <main className="flex-grow grid lg:grid-cols-12 items-center px-8 lg:px-24 overflow-hidden">

                {/* Left Side: Bold Impact - Fixed overlapping with smaller max font and width control */}
                ...
                {/* Right Side: Simple Form - Added more padding-left (lg:pl-32) for a cleaner gutter */}
                <div className="lg:col-span-7 lg:pl-32 lg:border-l border-black/5 h-full flex flex-col justify-center">
                    {!submitted ? (
                        <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-10 max-w-xl w-full">
                            ...
                            <div className="grid grid-cols-2 gap-10">
                                ...
                                <div className="reveal group">
                                    ...
                                    <input type="email" placeholder="email@address.com" required className={inputClasses} />
                                    <div className="line-grow h-[1px] w-full bg-black/5 origin-left group-focus-within:bg-[#FF4F00] transition-colors mt-1" />
                                </div>
                            </div>
                            ...
                            <div className="reveal group">
                                ...
                                <div className="relative">
                                    <select className={`${inputClasses} appearance-none cursor-pointer pr-10 relative z-10`}>
                            ...
                            <div className="reveal pt-4">
                                <button
                                    type="submit"
                                    className="group flex items-center justify-between w-full border border-black/10 p-1 bg-white hover:border-[#2D5A43] transition-all duration-500 shadow-sm"
                                >
                                    <span className="font-sans text-[9px] font-bold tracking-[0.5em] uppercase pl-8 text-[#1A1A1A]">Submit Briefing</span>
                                    <div className="bg-[#2D5A43] p-6 group-hover:bg-[#FF4F00] transition-colors duration-500">
                                        <MoveRight size={24} className="text-white group-hover:translate-x-2 transition-transform duration-500" strokeWidth={1} />
                                    </div>
                                </button>
                            </div>
            ...
            <footer className="flex-none p-12 flex justify-between items-center opacity-20">
